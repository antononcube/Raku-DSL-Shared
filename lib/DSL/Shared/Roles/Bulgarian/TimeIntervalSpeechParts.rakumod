...
role DSL::Shared::Roles::Bulgarian::TimeIntervalSpeechParts {
  ...
  token apr-time-spec-word:sym<Bulgarian> { :i 'април' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'април', 2) }> }
  token april-time-spec-word:sym<Bulgarian> { :i 'април' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'април', 2) }> }
  token aug-time-spec-word:sym<Bulgarian> { :i 'август' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'август', 2) }> }
  ...
  token days-time-spec-word:sym<Bulgarian> { :i 'дни' | ([\w]+) <?{ $0.Str !(elem) <ден дек яну юли юни на един една едно едни десни днес> and is-fuzzy-match($0.Str, 'дни', 1) }> }
  ...
  token jan-time-spec-word:sym<Bulgarian> { :i 'яну' | ([\w]+) <?{ $0.Str !(elem) <дни юни на> and is-fuzzy-match($0.Str, 'яну', 1) }> }
  ...
  token jun-time-spec-word:sym<Bulgarian> { :i 'юни' | ([\w]+) <?{ $0.Str !(elem) <дни яну юли на едни> and is-fuzzy-match($0.Str, 'юни', 1) }> }
  token june-time-spec-word:sym<Bulgarian> { :i 'юни' | ([\w]+) <?{ $0.Str !(elem) <дни яну юли на едни> and is-fuzzy-match($0.Str, 'юни', 1) }> }
  ...
  token mar-time-spec-word:sym<Bulgarian> { :i 'мар' | ([\w]+) <?{ $0.Str !(elem) <час март май на> and is-fuzzy-match($0.Str, 'мар', 1) }> }
  ...
  token mon-time-spec-word:sym<Bulgarian> { :i 'пон' | ([\w]+) <?{ $0.Str !(elem) <ден нов ное> and is-fuzzy-match($0.Str, 'пон', 1) }> }
  ...
  token new-time-spec-word:sym<Bulgarian> { :i 'нов' | ([\w]+) <?{ $0.Str !(elem) <фев пон ное на> and is-fuzzy-match($0.Str, 'нов', 1) }> }
  ...
  token nov-time-spec-word:sym<Bulgarian> { :i 'ное' | ([\w]+) <?{ $0.Str !(elem) <пон нов на> and is-fuzzy-match($0.Str, 'ное', 1) }> }
  ...
  token oct-time-spec-word:sym<Bulgarian> { :i 'окт' | ([\w]+) <?{ $0.Str ne 'чет' and is-fuzzy-match($0.Str, 'окт', 1) }> }
  token october-time-spec-word:sym<Bulgarian> { :i 'октомври' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'октомври', 2) }> }
  token of-time-spec-word:sym<Bulgarian> { :i 'на' }
  ...
  token past-time-spec-word:sym<Bulgarian> { :i 'минало' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'минало', 2) }> }
  ...
  token thu-time-spec-word:sym<Bulgarian> { :i 'чет' | ([\w]+) <?{ $0.Str !(elem) <ден дек фев час окт сеп> and is-fuzzy-match($0.Str, 'чет', 1) }> }
  ...
  token tue-time-spec-word:sym<Bulgarian> { :i 'вто' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'вто', 1) }> }
