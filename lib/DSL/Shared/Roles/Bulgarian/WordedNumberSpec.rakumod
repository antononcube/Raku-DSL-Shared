...
role DSL::Shared::Roles::Bulgarian::WordedNumberSpec {
  ...
  rule bg-worded-number-spec { <bg_worded_number_up_to_bil> }
  ...
  token bg_name_of_1  {'едно'}
  token bg_name_of_2  {'две'}
  ...
  token bg_name_of_19 {'деетнадесет'   | 'деветнайсе'  | 'деветнайсет'}
