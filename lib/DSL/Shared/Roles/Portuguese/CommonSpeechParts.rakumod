...
role DSL::Shared::Roles::Portuguese::CommonSpeechParts {
    ...
    token IDENTIFIER-adjective:sym<Portuguese> { :i 'identificador' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'identificador', 2) }> | 'id' | 'id' | 'id' }
    token IDENTIFIER-noun:sym<Portuguese> { :i 'identificador' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'identificador', 2) }> | 'identificador' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'identificador', 2) }> }
    ...
    token TARGET-noun:sym<Portuguese> { :i 'meta' | ([\w]+) <?{ $0.Str !(elem) <mapa peça data> and is-fuzzy-match($0.Str, 'meta', 2) }> | 'propósito' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'propósito', 2) }> }
    ...
    token add-verb { 'recuperado de' | 'acrescentar' }
    token adhere-verb { 'guarda' | 'de acordo com' }
    ...
    token as-preposition:sym<Portuguese> { :i 'como' | ([\w]+) <?{ $0.Str !(elem) <caso com nome topo> and is-fuzzy-match($0.Str, 'como', 2) }> }
    ...
    token automatic:sym<Portuguese> { :i 'automático' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'automático', 2) }> | 'automático' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'automático', 2) }> | 'automaticamente' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'automaticamente', 2) }> | 'automático' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'automático', 2) }> }
    ...
    token be-verb:sym<Portuguese> { :i 'ser' | ([\w]+) <?{ $0.Str !(elem) <são em de vir sem por> and is-fuzzy-match($0.Str, 'ser', 1) }> }
    token both-determiner:sym<Portuguese> { :i  'и'? 'ambos' | 'simultaneamente' | 'juntos'  }
    token bottom-noun:sym<Portuguese> { :i 'fundo' | ([\w]+) <?{ $0.Str ne 'quando' and is-fuzzy-match($0.Str, 'fundo', 2) }> | 'най-ниско' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'най-ниско', 2) }> }
    token broaden-verb:sym<Portuguese> { :i 'expandir' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'expandir', 2) }> }
    token by-preposition { 'a partir de' | 'com' | 'via' }
    ...
    token channel-adjective:sym<Portuguese> { :i 'canal' | ([\w]+) <?{ $0.Str !(elem) <cada casual> and is-fuzzy-match($0.Str, 'canal', 2) }> | 'canal' | ([\w]+) <?{ $0.Str !(elem) <cada casual> and is-fuzzy-match($0.Str, 'canal', 2) }> | 'canal' | ([\w]+) <?{ $0.Str !(elem) <cada casual> and is-fuzzy-match($0.Str, 'canal', 2) }> | 'canal' | ([\w]+) <?{ $0.Str !(elem) <cada casual> and is-fuzzy-match($0.Str, 'canal', 2) }> }
    ...
    token chart-verb:sym<Portuguese> { :i 'sorteio' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'sorteio', 2) }> | 'sorteio' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'sorteio', 2) }> }
    ...
    token compute-directive:sym<Portuguese> { :i 'calcular' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'calcular', 2) }> | 'encontrar' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'encontrar', 2) }> | 'calcular' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'calcular', 2) }> | 'calcular' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'calcular', 2) }> }
    token config-noun:sym<Portuguese> { :i 'configurar' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'configurar', 2) }> }
    token configuration-adjective:sym<Portuguese> { :i 'configuração' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'configuração', 2) }> | 'configuração' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'configuração', 2) }> | 'configuração' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'configuração', 2) }> | 'configuração' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'configuração', 2) }> }
    ...
    token consider-verb { 'check out' }
    token context-noun:sym<Portuguese> { :i 'antecedentes' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'antecedentes', 2) }> }
    token contingency-noun { 'contingente' | 'referência cruzada' 'tabling' }
    token convert-verb:sym<Portuguese> { :i 'converter' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'converter', 2) }> }
    token conveyor-adjective:sym<Portuguese> { :i 'transportador' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'transportador', 2) }> | 'transportador' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'transportador', 2) }> | 'transportador' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'transportador', 2) }> | 'transportador' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'transportador', 2) }> }
    ...
    token current-adjective:sym<Portuguese> { :i 'actual' | ([\w]+) <?{ $0.Str ne 'casual' and is-fuzzy-match($0.Str, 'actual', 2) }> | 'actual' | ([\w]+) <?{ $0.Str ne 'casual' and is-fuzzy-match($0.Str, 'actual', 2) }> | 'actual' | ([\w]+) <?{ $0.Str ne 'casual' and is-fuzzy-match($0.Str, 'actual', 2) }> }
    token data-adjective:sym<Portuguese> { :i 'dados' | ([\w]+) <?{ $0.Str !(elem) <todos casos datas> and is-fuzzy-match($0.Str, 'dados', 2) }> | 'dannova' | ([\w]+) <?{ $0.Str ne 'dannovo' and is-fuzzy-match($0.Str, 'dannova', 2) }> | 'dannovo' | ([\w]+) <?{ $0.Str ne 'dannova' and is-fuzzy-match($0.Str, 'dannovo', 2) }> | 'dados' | ([\w]+) <?{ $0.Str !(elem) <todos casos datas> and is-fuzzy-match($0.Str, 'dados', 2) }> }
    token data-noun:sym<Portuguese> { :i 'dados' | ([\w]+) <?{ $0.Str !(elem) <todos casos datas> and is-fuzzy-match($0.Str, 'dados', 2) }> | 'dados' | ([\w]+) <?{ $0.Str !(elem) <todos casos datas> and is-fuzzy-match($0.Str, 'dados', 2) }> | 'dannova' | ([\w]+) <?{ $0.Str ne 'dannovo' and is-fuzzy-match($0.Str, 'dannova', 2) }> }
    token dataset:sym<Portuguese> { :i <dataset-noun> }
    token dataset-noun { 'conjunto de dados' | 'ficha de dados' \h+ 'conjunto' | <array-noun> 'a partir de' <data-noun> | <data-adjective> \h+ <array-noun>}
    token datasets-noun { 'conjuntos de dados' | <arrays-noun> \h+ 'a partir de' \h+ <data-noun> | <data-adjective> \h+ <arrays-noun> }
    token date-adjective:sym<Portuguese> { :i 'datas' | ([\w]+) <?{ $0.Str !(elem) <dados data fitas> and is-fuzzy-match($0.Str, 'datas', 2) }> | 'data' | ([\w]+) <?{ $0.Str !(elem) <meta cada mapa datas para falta> and is-fuzzy-match($0.Str, 'data', 2) }> | 'data' | ([\w]+) <?{ $0.Str !(elem) <meta cada mapa datas para falta> and is-fuzzy-match($0.Str, 'data', 2) }> | 'data' | ([\w]+) <?{ $0.Str !(elem) <meta cada mapa datas para falta> and is-fuzzy-match($0.Str, 'data', 2) }> }
    ...
    token each-determiner:sym<Portuguese> { :i 'cada' | ([\w]+) <?{ $0.Str !(elem) <caso canal mapa data para carga> and is-fuzzy-match($0.Str, 'cada', 2) }> | 'cada' | ([\w]+) <?{ $0.Str !(elem) <caso canal mapa data para carga> and is-fuzzy-match($0.Str, 'cada', 2) }> | 'cada' | ([\w]+) <?{ $0.Str !(elem) <caso canal mapa data para carga> and is-fuzzy-match($0.Str, 'cada', 2) }> }
    ...
    token empty-noun { 'em branco' | 'vacuidade' }
    token empty-verb:sym<Portuguese> { :i  'vazio' | <empty-noun>  }
    token every-determiner:sym<Portuguese> { :i 'cada' | ([\w]+) <?{ $0.Str !(elem) <caso canal mapa data para carga> and is-fuzzy-match($0.Str, 'cada', 2) }> | 'cada' | ([\w]+) <?{ $0.Str !(elem) <caso canal mapa data para carga> and is-fuzzy-match($0.Str, 'cada', 2) }> | 'cada' | ([\w]+) <?{ $0.Str !(elem) <caso canal mapa data para carga> and is-fuzzy-match($0.Str, 'cada', 2) }> }
    token extend-verb:sym<Portuguese> { :i 'expandir' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'expandir', 2) }> }
    token extract-directive { 'recuperado de' | 'recuperado de' | 'minha' }
    ...
    token head-noun { 'testa' | 'dirigido a' }
    ...
    token how-adverb:sym<Portuguese> { :i 'como' | ([\w]+) <?{ $0.Str !(elem) <caso com nome topo> and is-fuzzy-match($0.Str, 'como', 2) }> }
    ...
    token include-verb:sym<Portuguese> { :i 'incluir' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'incluir', 2) }> | 'incluir' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'incluir', 2) }> }
    token ingest-verb { 'leia mais' }
    ...
    token it-pronoun:sym<Portuguese> { :i 'isto' | ([\w]+) <?{ $0.Str !(elem) <são alto lista este> and is-fuzzy-match($0.Str, 'isto', 2) }> | 'que' | ([\w]+) <?{ $0.Str !(elem) <um de ou quem> and is-fuzzy-match($0.Str, 'que', 1) }> }
    ...
    token last-adjective { 'último' | 'últimos' | 'o mais recente' }
    token left-adjective:sym<Portuguese> { :i 'esquerda' | ([\w]+) <?{ $0.Str ne 'esqueça' and is-fuzzy-match($0.Str, 'esquerda', 2) }> | 'esquerda' | ([\w]+) <?{ $0.Str ne 'esqueça' and is-fuzzy-match($0.Str, 'esquerda', 2) }> | 'esquerda' | ([\w]+) <?{ $0.Str ne 'esqueça' and is-fuzzy-match($0.Str, 'esquerda', 2) }> | 'esquerda' | ([\w]+) <?{ $0.Str ne 'esqueça' and is-fuzzy-match($0.Str, 'esquerda', 2) }> }
    ...
    token list-noun:sym<Portuguese> { :i 'lista' | ([\w]+) <?{ $0.Str !(elem) <isto linha> and is-fuzzy-match($0.Str, 'lista', 2) }> }
    token load-verb:sym<Portuguese> { :i 'carga' | ([\w]+) <?{ $0.Str !(elem) <cada para> and is-fuzzy-match($0.Str, 'carga', 2) }> | 'carregar' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'carregar', 2) }> }
    ...
    token lower-adjective:sym<Portuguese> { :i 'по-долен' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'по-долен', 2) }> | 'fundo' | ([\w]+) <?{ $0.Str ne 'quando' and is-fuzzy-match($0.Str, 'fundo', 2) }> }
    token make-noun:sym<Portuguese> { :i 'do' }
    token making-noun:sym<Portuguese> { :i 'fazendo' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'fazendo', 2) }> }
    token manner { 'caminho' | 'à maneira' }
    ...
    token maximum:sym<Portuguese> { :i 'max' | ([\w]+) <?{ $0.Str !(elem) <mapa faz a> and is-fuzzy-match($0.Str, 'max', 1) }> | 'máximo' | ([\w]+) <?{ $0.Str ne 'mínimo' and is-fuzzy-match($0.Str, 'máximo', 2) }> | 'máximo' | ([\w]+) <?{ $0.Str ne 'mínimo' and is-fuzzy-match($0.Str, 'máximo', 2) }> }
    token message-noun:sym<Portuguese> { :i 'mensagem' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'mensagem', 2) }> }
    token method-adjective:sym<Portuguese> { :i 'método' | ([\w]+) <?{ $0.Str ne 'métodos' and is-fuzzy-match($0.Str, 'método', 2) }> | 'método' | ([\w]+) <?{ $0.Str ne 'métodos' and is-fuzzy-match($0.Str, 'método', 2) }> | 'metodicamente' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'metodicamente', 2) }> | 'metódico' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'metódico', 2) }> }
    ...
    token minimum:sym<Portuguese> { :i 'minha' | ([\w]+) <?{ $0.Str ne 'linha' and is-fuzzy-match($0.Str, 'minha', 2) }> | 'mínimo' | ([\w]+) <?{ $0.Str ne 'máximo' and is-fuzzy-match($0.Str, 'mínimo', 2) }> | 'mínimo' | ([\w]+) <?{ $0.Str ne 'máximo' and is-fuzzy-match($0.Str, 'mínimo', 2) }> }
    ...
    token my-determiner { 'o meu' | 'o meu' | 'o meu' }
    ...
    token nearest-adjective:sym<Portuguese> { :i 'най-близък' | ([\w]+) <?{ $0.Str ne 'най-близки' and is-fuzzy-match($0.Str, 'най-близък', 2) }> | 'най-близки' | ([\w]+) <?{ $0.Str ne 'най-близък' and is-fuzzy-match($0.Str, 'най-близки', 2) }> }
    token neighbors-noun:sym<Portuguese> { :i 'vizinhos' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'vizinhos', 2) }> | 'vizinhos' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'vizinhos', 2) }> }
    token no-determiner:sym<Portuguese> { :i 'sem' | ([\w]+) <?{ $0.Str !(elem) <um são ser com em de quem> and is-fuzzy-match($0.Str, 'sem', 1) }> }
    ...
    token obtain-verb { 'recuperado de' | 'minha' }
    ...
    token off-adverb:sym<Portuguese> { :i 'sem' | ([\w]+) <?{ $0.Str !(elem) <um são ser com em de quem> and is-fuzzy-match($0.Str, 'sem', 1) }> }
    token on-preposition:sym<Portuguese> { :i 'em' | 'por' | ([\w]+) <?{ $0.Str !(elem) <fora ser do para com vir no ou o hora> and is-fuzzy-match($0.Str, 'por', 1) }> }
    ...
    token our-determiner { 'o nosso' | 'o nosso' | 'o nosso' }
    token out-adverb:sym<Portuguese> { :i 'fora' | ([\w]+) <?{ $0.Str !(elem) <para por hora> and is-fuzzy-match($0.Str, 'fora', 2) }> | 'fora' | ([\w]+) <?{ $0.Str !(elem) <para por hora> and is-fuzzy-match($0.Str, 'fora', 2) }> }
    token outlier-adjective:sym<Portuguese> { :i 'extraordinário' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'extraordinário', 2) }> | 'extraordinário' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'extraordinário', 2) }> | 'extraordinário' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'extraordinário', 2) }> | 'extraordinário' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'extraordinário', 2) }> }
    token outlier-noun:sym<Portuguese> { :i 'emergência' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'emergência', 2) }> | 'extraordinário' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'extraordinário', 2) }> 'valor' | ([\w]+) <?{ $0.Str ne 'valores' and is-fuzzy-match($0.Str, 'valor', 2) }> }
    token outliers-noun:sym<Portuguese> { :i 'extraordinário' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'extraordinário', 2) }> | 'extraordinário' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'extraordinário', 2) }> 'valores' | ([\w]+) <?{ $0.Str ne 'valor' and is-fuzzy-match($0.Str, 'valores', 2) }> }
    token over-preposition:sym<Portuguese> { :i 'via' | ([\w]+) <?{ $0.Str !(elem) <id vir a vs.> and is-fuzzy-match($0.Str, 'via', 1) }> | 'via' | ([\w]+) <?{ $0.Str !(elem) <id vir a vs.> and is-fuzzy-match($0.Str, 'via', 1) }> | 'por' | ([\w]+) <?{ $0.Str !(elem) <fora ser do para com vir no ou o hora> and is-fuzzy-match($0.Str, 'por', 1) }> }
    ...
    token pull-noun { 'recuperado de' | 'puxar' }
    token pull-verb { 'recuperado de' | 'puxar para cima' }
    ...
    token replace-verb:sym<Portuguese> { :i 'substituir' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'substituir', 2) }> | 'substituir' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'substituir', 2) }> }
    token represent-directive:sym<Portuguese> { :i  <represent-verb> | 'sorteio' | 'reflectir'  }
    token represent-verb { 'apresentado por' }
    ...
    token right-adjective:sym<Portuguese> { :i 'direita' | ([\w]+) <?{ $0.Str ne 'directo' and is-fuzzy-match($0.Str, 'direita', 2) }> | 'certo' | ([\w]+) <?{ $0.Str ne 'texto' and is-fuzzy-match($0.Str, 'certo', 2) }> | 'certo' | ([\w]+) <?{ $0.Str ne 'texto' and is-fuzzy-match($0.Str, 'certo', 2) }> | 'certo' | ([\w]+) <?{ $0.Str ne 'texto' and is-fuzzy-match($0.Str, 'certo', 2) }> }
    token right-noun:sym<Portuguese> { :i 'direita' | ([\w]+) <?{ $0.Str ne 'directo' and is-fuzzy-match($0.Str, 'direita', 2) }> }
    token row-noun:sym<Portuguese> { :i 'linha' | ([\w]+) <?{ $0.Str !(elem) <lista minha> and is-fuzzy-match($0.Str, 'linha', 2) }> }
    ...
    token running-verb { 'em funcionamento' }
    token separate-verb:sym<Portuguese> { :i 'tabs' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'tabs', 2) }> }
    token series-noun { 'série' | 'linha' | 'uma série de' }
    ...
    token setup-adjective:sym<Portuguese> { :i 'sintonizar' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'sintonizar', 2) }> | 'afinação' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'afinação', 2) }> | 'sintonizar' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'sintonizar', 2) }> | 'afinação' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'afinação', 2) }> | 'inicialização' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'inicialização', 2) }> | 'inicialização' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'inicialização', 2) }> | 'inicialização' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'inicialização', 2) }> | 'inicialização' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'inicialização', 2) }> }
    ...
    token show-verb:sym<Portuguese> { :i 'mostrar' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'mostrar', 2) }> | 'mostrar' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'mostrar', 2) }> }
    ...
    token smallest:sym<Portuguese> { :i 'най-малък' | ([\w]+) <?{ $0.Str ne 'най-малки' and is-fuzzy-match($0.Str, 'най-малък', 2) }> | 'най-малки' | ([\w]+) <?{ $0.Str ne 'най-малък' and is-fuzzy-match($0.Str, 'най-малки', 2) }> }
    token smallest-adjective:sym<Portuguese> { :i 'най-малък' | ([\w]+) <?{ $0.Str ne 'най-малки' and is-fuzzy-match($0.Str, 'най-малък', 2) }> | 'най-малки' | ([\w]+) <?{ $0.Str ne 'най-малък' and is-fuzzy-match($0.Str, 'най-малки', 2) }> }
    token some-determiner { 'alguém' | 'cerca de' }
    ...
    token step-noun:sym<Portuguese> { :i 'etapa' | ([\w]+) <?{ $0.Str !(elem) <mapa etapas> and is-fuzzy-match($0.Str, 'etapa', 2) }> | 'passo' | ([\w]+) <?{ $0.Str !(elem) <caso casos passos peso pesos> and is-fuzzy-match($0.Str, 'passo', 2) }> }
    ...
    token tape-adjective:sym<Portuguese> { :i 'cassetes' | ([\w]+) <?{ $0.Str ne 'cassete' and is-fuzzy-match($0.Str, 'cassetes', 2) }> | 'cassete' | ([\w]+) <?{ $0.Str ne 'cassetes' and is-fuzzy-match($0.Str, 'cassete', 2) }> | 'fitas' | ([\w]+) <?{ $0.Str !(elem) <datas filas> and is-fuzzy-match($0.Str, 'fitas', 2) }> | 'fitas' | ([\w]+) <?{ $0.Str !(elem) <datas filas> and is-fuzzy-match($0.Str, 'fitas', 2) }> }
    ...
    token text-noun:sym<Portuguese> { :i 'texto' | ([\w]+) <?{ $0.Str !(elem) <certo textos> and is-fuzzy-match($0.Str, 'texto', 2) }> }
    token texts-noun:sym<Portuguese> { :i 'textos' | ([\w]+) <?{ $0.Str ne 'texto' and is-fuzzy-match($0.Str, 'textos', 2) }> }
    token textual-adjective:sym<Portuguese> { :i 'textos' | ([\w]+) <?{ $0.Str ne 'texto' and is-fuzzy-match($0.Str, 'textos', 2) }> | 'texto' | ([\w]+) <?{ $0.Str !(elem) <certo textos> and is-fuzzy-match($0.Str, 'texto', 2) }> | 'texto' | ([\w]+) <?{ $0.Str !(elem) <certo textos> and is-fuzzy-match($0.Str, 'texto', 2) }> | 'texto' | ([\w]+) <?{ $0.Str !(elem) <certo textos> and is-fuzzy-match($0.Str, 'texto', 2) }> }
    token that-pronoun:sym<Portuguese> { :i 'esses' | ([\w]+) <?{ $0.Str !(elem) <eles este> and is-fuzzy-match($0.Str, 'esses', 2) }> | 'que' | ([\w]+) <?{ $0.Str !(elem) <um de ou quem> and is-fuzzy-match($0.Str, 'que', 1) }> }
    ...
    token this-pronoun:sym<Portuguese> { :i 'este' | ([\w]+) <?{ $0.Str !(elem) <isto esses> and is-fuzzy-match($0.Str, 'este', 2) }> | 'isto' | ([\w]+) <?{ $0.Str !(elem) <são alto lista este> and is-fuzzy-match($0.Str, 'isto', 2) }> }
    token threshold-adjective:sym<Portuguese> { :i 'limiar' | ([\w]+) <?{ $0.Str !(elem) <limpar eliminar limiares> and is-fuzzy-match($0.Str, 'limiar', 2) }> | 'limiar' | ([\w]+) <?{ $0.Str !(elem) <limpar eliminar limiares> and is-fuzzy-match($0.Str, 'limiar', 2) }> | 'limiar' | ([\w]+) <?{ $0.Str !(elem) <limpar eliminar limiares> and is-fuzzy-match($0.Str, 'limiar', 2) }> | 'limiares' | ([\w]+) <?{ $0.Str ne 'limiar' and is-fuzzy-match($0.Str, 'limiares', 2) }> }
    ...
    token used-verb { 'recuperado de' | 'usado' }
    ...
    token which-determiner:sym<Portuguese> { :i 'quem' | ([\w]+) <?{ $0.Str !(elem) <um em que sem> and is-fuzzy-match($0.Str, 'quem', 2) }> | 'que' | ([\w]+) <?{ $0.Str !(elem) <um de ou quem> and is-fuzzy-match($0.Str, 'que', 1) }> }
    token with-preposition:sym<Portuguese> { :i 'via' | ([\w]+) <?{ $0.Str !(elem) <id vir a vs.> and is-fuzzy-match($0.Str, 'via', 1) }> | 'с' | 'com' | ([\w]+) <?{ $0.Str !(elem) <um como do em no nome sem por ou o> and is-fuzzy-match($0.Str, 'com', 1) }> | 'no' | 'por' | ([\w]+) <?{ $0.Str !(elem) <fora ser do para com vir no ou o hora> and is-fuzzy-match($0.Str, 'por', 1) }> }
    token without-preposition:sym<Portuguese> { :i 'sem' | ([\w]+) <?{ $0.Str !(elem) <um são ser com em de quem> and is-fuzzy-match($0.Str, 'sem', 1) }> }
