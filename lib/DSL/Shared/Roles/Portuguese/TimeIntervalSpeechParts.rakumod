...
role DSL::Shared::Roles::Portuguese::TimeIntervalSpeechParts {
  ...
  token apr-time-spec-word:sym<Portuguese> { :i 'apr' | ([\w]+) <?{ $0.Str !(elem) <am aug mar pm ano> and is-fuzzy-match($0.Str, 'apr', 1) }> }
  token april-time-spec-word:sym<Portuguese> { :i 'abril' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'abril', 2) }> }
  token aug-time-spec-word:sym<Portuguese> { :i 'aug' | ([\w]+) <?{ $0.Str !(elem) <am apr jul jun um ano> and is-fuzzy-match($0.Str, 'aug', 1) }> }
  ...
  token day-time-spec-word:sym<Portuguese> { :i 'dia' | ([\w]+) <?{ $0.Str !(elem) <dias dez de> and is-fuzzy-match($0.Str, 'dia', 1) }> }
  token days-time-spec-word:sym<Portuguese> { :i 'dias' | ([\w]+) <?{ $0.Str ne 'dia' and is-fuzzy-match($0.Str, 'dias', 2) }> }
  token dec-time-spec-word:sym<Portuguese> { :i 'dez' | ([\w]+) <?{ $0.Str !(elem) <dia fev de sep em> and is-fuzzy-match($0.Str, 'dez', 1) }> }
  ...
  token feb-time-spec-word:sym<Portuguese> { :i 'fev' | ([\w]+) <?{ $0.Str !(elem) <dez nov de sep em> and is-fuzzy-match($0.Str, 'fev', 1) }> }
  ...
  token fri-time-spec-word:sym<Portuguese> { :i 'sexta' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'sexta', 2) }> }
  ...
  token mar-time-spec-word:sym<Portuguese> { :i 'mar' | ([\w]+) <?{ $0.Str !(elem) <am apr jan março maio mês mãe sat> and is-fuzzy-match($0.Str, 'mar', 1) }> }
  ...
  token mon-time-spec-word:sym<Portuguese> { :i 'segunda' | ([\w]+) <?{ is-fuzzy-match($0.Str, 'segunda', 2) }> }
  ...
  token sat-time-spec-word:sym<Portuguese> { :i 'sat' | ([\w]+) <?{ $0.Str !(elem) <am jan mar oct sep sol> and is-fuzzy-match($0.Str, 'sat', 1) }> }
  ...
  token sep-time-spec-word:sym<Portuguese> { :i 'sep' | ([\w]+) <?{ $0.Str !(elem) <dez fev de sat sol em> and is-fuzzy-match($0.Str, 'sep', 1) }> }
  token september-time-spec-word:sym<Portuguese> { :i 'setembro' | ([\w]+) <?{ $0.Str ne 'dezembro' and is-fuzzy-match($0.Str, 'setembro', 2) }> }
  token sun-time-spec-word:sym<Portuguese> { :i 'sol' | ([\w]+) <?{ $0.Str !(elem) <jul nov sat sep> and is-fuzzy-match($0.Str, 'sol', 1) }> }
